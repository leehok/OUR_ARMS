...
<?php $__env->startSection('content'); ?>
    <b><h3 class="page-title"><?php echo app('translator')->get('quickadmin.roles.title'); ?></b></h3>
    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('role_create')): ?>
    <p>
        <a href="<?php echo e(route('admin.roles.create')); ?>" class="btn btn-success"><?php echo app('translator')->get('quickadmin.qa_add_new'); ?></a>
...
<?php echo Form::open(array(
                    ...
                    <?php else: ?>
                        <tr>
                            <td colspan="6"><?php echo app('translator')->get('quickadmin.qa_no_entries_in_table'); ?></td>
                        </tr>
                    <?php endif; ?>
                </tbody>
            </table>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\dev-ams\resources\views/admin/roles/index.blade.php ENDPATH**/ ?>